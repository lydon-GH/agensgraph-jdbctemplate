...
import com.example.agensgraph.util.*;
        ...
        if (this.nodes != null && this.nodes.size() > 0) {
            ...
            while(iter.hasNext()) {
                ...
                if (map.containsKey(node.getLabel())) {
                    ...
                    label = storage.findLabelTypeCopy(LabelType.ElemType.NODE, node.getLabel());
                    if (label != null) {
                        try {
        ...
        if (this.edges != null && this.edges.size() > 0) {
            ...
            while(iter.hasNext()) {
                ...
                if (map.containsKey(edge.getLabel())) {
                    ...
                    label = storage.findLabelTypeCopy(LabelType.ElemType.EDGE, edge.getLabel());
                    if (label != null) {
                        try {
                            clone = (LabelType)label.clone();
                            clone.setSize(1L);
