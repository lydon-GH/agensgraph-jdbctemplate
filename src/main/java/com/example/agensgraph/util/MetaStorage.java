...
import com.example.agensgraph.entity.model.*;
...
public class MetaStorage {
    ...
    public int getNodesSize() {
        ...
        while(iter.hasNext()) {
            ...
            if (labelType.getType().equals(LabelType.ElemType.NODE)) {
                ++size;
            }
        }
    ...
    public int getEdgesSize() {
        ...
        while(iter.hasNext()) {
            LabelType labelType = (LabelType)iter.next();
            if (labelType.getType().equals(LabelType.ElemType.EDGE)) {
                ++size;
            }
        }
    ...
    public LabelType findLabelType(LabelType.ElemType type, String name) {
        Iterator iter = this.labels.iterator();
    ...
    public LabelType findLabelTypeCopy(LabelType.ElemType type, String name) {
        Iterator iter = this.labelsCopy.iterator();
